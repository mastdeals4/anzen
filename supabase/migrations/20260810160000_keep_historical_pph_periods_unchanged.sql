-- Do not rewrite historical PPh attribution. Existing rows continue to use the
-- established expense-date rule until a user expressly selects a reporting
-- period. The companion field is therefore opt-in, not a historical backfill.
BEGIN;

UPDATE public.finance_expenses
   SET pph_tax_period_id = NULL
 WHERE pph_tax_period_id IS NOT NULL;
