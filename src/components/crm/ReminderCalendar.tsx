      ...
      >
        ...
        {selectedAppointment && (
          <div className="space-y-4">
            ...
            {selectedAppointment.customers && (
              <div>
                <label className="text-sm font-medium text-gray-700">Customer</label>
                <p className="text-sm text-gray-600 mt-1">{selectedAppointment.customers.company_name}</p>
              </div>
            )}
            ...
            {selectedAppointment.participants && selectedAppointment.participants.length > 0 && (
              <div className="border-t pt-4">
                <label className="text-sm font-medium text-gray-700">Participants ({selectedAppointment.participants.length})</label>
                <div className="mt-2 space-y-1">
                  {participantDetails.map(participant => (
                    <div key={participant.id} className="flex items-center gap-2 text-sm text-gray-600">
