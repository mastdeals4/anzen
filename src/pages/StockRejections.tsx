...
export default function StockRejections() {
  ...
  return (
    <div className="space-y-3">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2.5 pb-2 border-b border-gray-200">
        <h1 className="text-lg sm:text-xl font-bold text-gray-900 tracking-tight">
          {t('stockRejections.title') || 'Stock Rejections'}
        </h1>
        <button
          onClick={() => setShowCreateModal(true)}
          className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 bg-red-600 text-white rounded-lg text-xs font-semibold hover:bg-red-700 shadow-xs transition-colors"
        >
          <AlertTriangle className="w-3.5 h-3.5" />
          {t('stockRejections.createRejection') || 'New Rejection'}
        </button>
      </div>
